...
An open, modular embodied AI robotics ecosystem: an autonomous mobile base, an upper body for manipulation, and the ROS 2 software, firmware, and hardware designs that make them one robot.

> **Status:** Active

![OpenAMRobot ecosystem](https://raw.githubusercontent.com/openAMRobot/openamr/main/docs/hardware/pictures/OpenAMRobot_ecosystem.png)

## Start here

| I want to | Go to |
| --- | --- |
| Understand how the pieces fit | [openamrobot-docs](https://github.com/openAMRobot/openamrobot-docs) |
| Get a working system | [openamrobot-release](https://github.com/openAMRobot/openamrobot-release) |
| Build or modify one part | [The repository index](https://github.com/openAMRobot/openamrobot-docs#repository-index) |

## Commercial and custom work

OpenAMRobot ships as open source. Botshare also sells assembled platforms, DIY kits, dual-arm embodied AI platforms, and custom engineering work, from architecture and PCB design through ROS 2 development, simulation, and manufacturing support.

| Offering | Starting price |
| --- | ---: |
| Mobile robot platform, components and chassis production, MIT license | **€3,500** |
| DIY development kit, assembled hardware, electronics, documentation, software | **€5,000** |
| Dual-arm embodied AI robot | **from €10,000** |

Prices are indicative for standard configurations. Final pricing depends on hardware options, sensors, arms, compute, manufacturing location, and customization. OEM, white-label, and joint development are available.
...
Maintained by Botshare Ltd. Most repositories are MIT licensed. See each repository's `LICENSE`.

[Contributing](https://github.com/openAMRobot/.github/blob/main/CONTRIBUTING.md) · [Governance](https://github.com/openAMRobot/.github/blob/main/GOVERNANCE.md) · [IP policy](https://github.com/openAMRobot/.github/blob/main/IP_POLICY.md) · [Roadmap](https://github.com/openAMRobot/.github/blob/main/ROADMAP.md) · [Maintainers](https://github.com/openAMRobot/.github/blob/main/MAINTAINERS.md) · [Contributors](https://github.com/openAMRobot/.github/blob/main/CONTRIBUTORS.md) · [Security](https://github.com/openAMRobot/.github/blob/main/SECURITY.md)
