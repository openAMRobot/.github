...
- Use the [Individual Contributor Agreement](INDIVIDUAL_CONTRIBUTOR_AGREEMENT.md) when contributing in your own capacity.
- Use the [Corporate Contributor Agreement](CORPORATE_CONTRIBUTOR_AGREEMENT.md) when an employer or organization owns, controls, sponsors, or authorizes the work.
...
Contributor records are handled under the [Contributor Privacy Notice](CONTRIBUTOR_PRIVACY_NOTICE.md). Public repositories must contain no signed agreements, residential addresses, identification documents, or private contact details.
